...
@section('metas')
    <title> OZ Cleaners | Track your all orders with us </title>
    <meta name="description" content="Any services you have taken from us, track all orders, change schedule, see the special offers for you or your profile status ">
    ...
    <link href="https://ozcleaners.com.au/register" rel="canonical">
...
<div class="container my-3 pt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <h1 style="font-size: 18px;" class="card-header text-dark">{{ __('Register') }}</div>
