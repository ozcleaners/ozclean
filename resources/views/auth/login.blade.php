...
@section('metas')
    <title> OZ Cleaners | One place to track all your cleaning services </title>
    <meta name="description" content="Oz Cleaners respect its clients and value their time, so we have developed the system where you can track anything related to your cleaning services or property maintenance">
    ...
    <link href="https://ozcleaners.com.au/login" rel="canonical">
...
<div class="container my-3 pt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <h1 style="font-size: 18px;" class="card-header text-dark">{{ __('Login') }}</h1>
