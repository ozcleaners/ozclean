...
@section('filter')
    @if(request()->id)
        <a href="{{ route('common_term_custom_field_edit', request()->id) }}?zone={{ request()->get('zone') }}&section_id={{ request()->get('custom_field_id') }}"
...
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-6">
                @include('admin.common.terms.rich-content-templates.breakdown-create-form')
            </div>
            <div class="col-md-6" style="font-size: 10px;">
                @include('admin.common.terms.rich-content-templates.breakdown-section-list')
            </div>
        </div>
    </div>
@endsection
            ...
            jQuery('#sortable').sortable({
                ...
                update: function (event, ui) {
                    ...
                    jQuery.ajax({
                        ...
                        url: "{{ route('common_term_custom_fields_breakdown_sorting') }}?id={{ request()->get('custom_field_id') }}",
