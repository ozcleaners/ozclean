<div id="service_content_breakdown">
    <div class="content_form">
        ...
        if (isset($termcustomfieldbreakdown)) {
            $route_url = route('common_term_custom_field_breakdown_update') . "?zone=" . request()->get('zone') . "&section_id=" . request()->get('custom_field_id') . "&custom_field_breakdown_id=" . request()->get('custom_field_breakdown_id');
        } else {
            $route_url = route('common_term_custom_field_breakdown_store') . "?zone=" . request()->get('zone') . "&section_id=" . request()->get('custom_field_id');
        }
        ?>
