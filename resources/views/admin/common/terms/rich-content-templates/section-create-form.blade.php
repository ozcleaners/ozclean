<div id="service_content_breakdown">
    <div class="content_form">
        ...
        if (isset($termcustomfield)) {
            $route_url = route('common_term_custom_field_update');
        } else {
            $route_url = route('common_term_custom_field_store');
        }
        ?>
        <form action="{{ $route_url }}" method="post">
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control" name="content_zone"
                       class="form-control"
                       value="{{ isset($termcustomfield) ? $termcustomfield->content_zone : request()->zone }}"
                       readonly>
            </div>
            <div class="form-group">
