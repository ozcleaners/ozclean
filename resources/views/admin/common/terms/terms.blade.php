                        ...
                        @slot('fields')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-check d-inline-block">
                                    ...
                                    <label class="radio-inline">
                                        {{ Form::radio('calculator_template', 'popup', (!empty($term) ? (($term->calculator_template == 'popup') ? 'popup' : '') : ''), ['class' => 'radio']) }}
                                        Popup
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="float-end">
                                    @if($term->parent == 3 )
                                        <a class="btn btn-sm btn-success py-0"
                                           href="{{ route('common_term_custom_field_seo', $term->id) }}">
                                            Zone
                                        </a>
                                    @endif
...
{{--                                    </div>--}}
                                @elseif(!empty($term->id) && $term->id == 66)
                        {{--                                <div class="float-end">--}}
                                        <a class="btn btn-sm btn-success py-0"
                                           href="{{ route('common_term_custom_field_edit', $term->id) }}">
                                            Custom Content
        ...
        <div class="tab-content mt-3 mb-3" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="details" role="tabpanel"
                ...
                <div class="form-group">
                    <label for="checklist" class="checklist">
                        Checklist
                        <div class="text-muted" style="font-size: 9px;">Ex: Name | https://domain.com</div>
                    </label>
                    {{ Form::text('checklist', (!empty($term->checklist) ? $term->checklist : NULL), ['class' => 'form-control', 'placeholder' => 'Enter checlist EX: label | link...']) }}
                </div>
                ...
                <div class="form-group">
                    <label for="checklist" class="checklist">
                        Alternative Name
                        <div class="text-muted" style="font-size: 9px;">Ex: Name1 | Name2</div>
                    </label>
                    {{ Form::textarea('alternative_name', (!empty($term->alternative_name) ? $term->alternative_name : NULL), ['class' => 'form-control', 'placeholder' => 'Enter alternative_name EX: Name1 | Name2...']) }}
                </div>
