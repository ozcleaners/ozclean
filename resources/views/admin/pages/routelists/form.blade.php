...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="col-md-8 col-lg-7 col-sm-12">
            <form action="{{ !empty($routelist) ? route('routelist_update') : route('routelist_store') }}"
                  method="post">
                @csrf
                @if (!empty($routelist))
                ...
                <div class="form-content">
                    ...
                    <div class="form-group select arrow_class">
                        ...
                        <select class="form-select select-box" name="show_menu" aria-label=".form-select-lg"
                                id="show_menu">
                            <option value="">Select one</option>
                            <option value="Yes"
                        ...
                        <div class="form-check">
                            ...
                            @foreach($menuPosition as  $value)
                                <div class="form-group d-inline-flex me-2">
                                    <input type="checkbox" id="routelist_index_{{$value}}" class="checkItem"
                                           name="dashboard_position[]"
                                           value="{{$value}}" {{!empty($routelist) && strstr($routelist->dashboard_position, $value) ? 'checked' : ''}}>
